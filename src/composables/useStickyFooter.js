...
export function useStickyFooter(tableRef, options = {}) {
    const { enabled = false, maxHeight = 'calc(100vh - 250px)', debounceMs = 100, } = options;
    let wrapper = null;
    ...
    const adjustFooterWidth = debounce(() => {
        ...
        rafId = requestAnimationFrame(() => {
            ...
            const footerCells = Array.from(footerRow.querySelectorAll('td, th'));
